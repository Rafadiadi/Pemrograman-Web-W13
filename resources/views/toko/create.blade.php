...
@section('content')
    ...
    <div class="card" style="max-width: 720px; margin: 0 auto;">
        <h2 style="margin-top:0;">Tambah Toko</h2>
        <p class="muted" style="margin-bottom: 18px;">Lengkapi informasi toko baru.</p>

        <form action="{{ route('toko.store') }}" method="POST" class="fields">
            @csrf
            <div>
